...
class Flights:
    ...
    def __init__(self, path="/home/hadoop-kg-llm-ddpt/dolphinfs_hdd_hadoop-kg-llm-ddpt/chengzihao02/Travel-R1/verl/utils/reward_score/database/flights/clean_Flights_2022.csv"):
        self.path = path
        self.data = None
