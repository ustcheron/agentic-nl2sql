...
city_state_set = open('/home/hadoop-kg-llm-ddpt/dolphinfs_hdd_hadoop-kg-llm-ddpt/chengzihao02/Travel-R1/verl/utils/reward_score/database/background/citySet_with_states.txt','r').read().split('\n')
